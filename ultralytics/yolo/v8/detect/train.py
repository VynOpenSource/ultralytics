...
class DetectionTrainer(BaseTrainer):
    ...
    def build_dataset(self, img_path, mode='train', batch=None):
        ...
        return build_yolo_dataset(self.args, img_path, batch, self.data, mode=mode, rect=mode == 'val', stride=gs, custom_methods=self.methods)
    ...
    def get_dataloader(self, dataset_path, batch_size=16, rank=0, mode='train'):
        ...
        if self.args.v5loader:
            ...
            return create_dataloader(path=dataset_path,
                                     ...
                                     shuffle=mode == 'train',
                                     seed=self.args.seed,
                                     delete_cache=getattr(self.args, 'delete_cache', None) or custom_args.get('delete_cache', False),
