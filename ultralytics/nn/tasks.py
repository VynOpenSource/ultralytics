...
def torch_safe_load(weight, dir=None):
    """
    ...
    file = attempt_download_asset(weight, dir=dir)  # search online if missing locally
    try:
...
def attempt_load_one_weight(weight, device=None, inplace=True, fuse=False, dir=None):
    """Loads a single model weights."""
    ckpt, weight = torch_safe_load(weight, dir=dir)  # load ckpt
